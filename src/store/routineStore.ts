    ...
    (set) => ({
      routines: [
        // Mon/Wed morning
        {
          ...
          idealSpawnTime: 360,
          taskConfigs: [
            { taskId: 't-gym', expiresAfterMinutes: 60 },         // dead after 7 AM
        ...
        // Tue/Thu morning
        {
          ...
          idealSpawnTime: 360,
          taskConfigs: [
            { taskId: 't-study', expiresAfterMinutes: 90 },       // dead after 7:30 AM
            { taskId: 't-cook', expiresAfterMinutes: 240 },
            { taskId: 't-sandhi-am', expiresAfterMinutes: 120 },
            { taskId: 't-protein-am', expiresAfterMinutes: 180 },
            { taskId: 't-eat-am', expiresAfterMinutes: 240 },
        ...
        // Friday morning
        {
          ...
          taskConfigs: [
            ...
            { taskId: 't-protein-am', expiresAfterMinutes: 180 },
            { taskId: 't-eat-am', expiresAfterMinutes: 240 },
            { taskId: 't-walk-office', expiresAfterMinutes: 240 }, // dead after 10 AM
          ],
          enabled: true,
        },
        // Friday game
