  ...
  persist(
    (set) => ({
      ...
      templates: [
        {
          ...
          entries: [
            ...
            { anchorId: 'anchor-work-end', spikeTime: toMinutes(17, 0), slotId: 'slot-evening' },
        ...
        },
        {
          ...
          name: 'Weekend',
          entries: [
            { anchorId: 'anchor-wake', spikeTime: toMinutes(8, 0), slotId: 'slot-morning' },
            { anchorId: 'anchor-sleep', spikeTime: toMinutes(22, 0), slotId: 'slot-night' },
          ],
        },
      ],
      ...
      updateAnchor: (id, updates) =>
        set((state) => ({ anchors: state.anchors.map((a) => (a.id === id ? { ...a, ...updates } : a)) })),
      deleteAnchor: (id) =>
